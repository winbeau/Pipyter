// Empty built-in catalog for xiaomi-token-plan-sgp.
...
export const XIAOMI_TOKEN_PLAN_SGP_MODELS: ModelCatalog<{}, "xiaomi-token-plan-sgp"> = flattenModelCatalog("xiaomi-token-plan-sgp", {});
