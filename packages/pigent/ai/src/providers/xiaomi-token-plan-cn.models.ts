// Empty built-in catalog for xiaomi-token-plan-cn.
...
export const XIAOMI_TOKEN_PLAN_CN_MODELS: ModelCatalog<{}, "xiaomi-token-plan-cn"> = flattenModelCatalog("xiaomi-token-plan-cn", {});
