 ...
 *
 * Existing apps switch imports from "@pipyter/pigent-ai" to
 * "@pipyter/pigent-ai/compat" unchanged; new code uses `createModels()`
...
/** @deprecated Static catalog read. Use `getBuiltinModel` from "@pipyter/pigent-ai/providers/all" or `Models.getModel()`. */
export const getModel = getBuiltinModel;

/** @deprecated Static catalog read. Use `getBuiltinModels` from "@pipyter/pigent-ai/providers/all" or `Models.getModels()`. */
export const getModels = getBuiltinModels;

/** @deprecated Static catalog read. Use `getBuiltinProviders` from "@pipyter/pigent-ai/providers/all" or `Models.getProviders()`. */
