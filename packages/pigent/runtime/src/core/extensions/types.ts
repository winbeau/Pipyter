...
// ---------------------------------------------------------------------------
// Minimal placeholder types for the legacy TUI/theme/keybinding surfaces.
// Pigent v0.1 does not ship a TUI or load project extensions; these signatures
// keep the retained extension event lifecycle types self-contained.
// ---------------------------------------------------------------------------

/** Legacy TUI key identifier. */
export type KeyId = string;
/** Legacy TUI component handle. */
export interface Component {
	readonly disposed?: boolean;
	dispose?(): void;
	handleInput?(data: { key: KeyId; input: string }): void;
	update?(): void;
}
...
export type BashToolInput = Record<string, unknown>;
export interface EditToolDetails {
	[key: string]: unknown;
}
export type EditToolInput = Record<string, unknown>;
export interface ReadToolDetails {
	[key: string]: unknown;
}
export type ReadToolInput = Record<string, unknown>;
...
export type FindToolInput = Record<string, unknown>;
export interface GrepToolDetails {
	[key: string]: unknown;
}
export type GrepToolInput = Record<string, unknown>;
export interface LsToolDetails {
	[key: string]: unknown;
}
export type LsToolInput = Record<string, unknown>;
...
export interface ExtensionUIContext {
	 ...
	 * extend `CustomEditor` from `@pipyter/pigent-runtime` and call
	 * `super.handleInput(data)` for keys you don't handle.
	 *
	 * @example
	 * ```ts
	 * import { CustomEditor } from "@pipyter/pigent-runtime";
	 *
