...
import type { AgentMessage } from "@pipyter/pigent-agent";
import type { ImageContent, Model, Provider, ProviderHeaders } from "@pipyter/pigent-ai";
import type { KeyId, Theme } from "./types.ts";
...
const buildBuiltinKeybindings = (resolvedKeybindings: unknown): BuiltInKeyBindings => {
	const builtinKeybindings = {} as BuiltInKeyBindings;
	for (const [keybinding, keys] of Object.entries((resolvedKeybindings ?? {}) as Record<string, unknown>)) {
...
export class ExtensionRunner {
	...
	getShortcuts(resolvedKeybindings: unknown): Map<KeyId, ExtensionShortcut> {
