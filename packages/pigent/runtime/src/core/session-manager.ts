...
import { type ImageContent, type Message, type TextContent, type Usage, uuidv7 } from "@pipyter/pigent-ai";
 ...
 * Encodes cwd into a safe directory name under Pigent config directory/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (Pigent config directory/sessions/<encoded-cwd>/).
	 */
