...
import { type Api, type KnownProvider, type Model, modelsAreEqual } from "@pipyter/pigent-ai";
import { minimatch } from "minimatch";
const chalk = { yellow: String, red: String, dim: String };
...
export function resolveCliModel(options: {
	...
	if (availableModels.length === 0) {
		return {
			model: undefined,
			warning: undefined,
			error: "No models available. Check your installation or configure models in settings.json.",
		};
	}
