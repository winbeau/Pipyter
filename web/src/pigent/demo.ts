...
export const demoSession: PigentSession = {
  ...
  execution_identity: { username: 'runtime-user', uid: null, home: '~', workspace: 'attention_sparsity' },
...
export const demoEvents: PigentEvent[] = [
  ...
  { version: 1, event_id: 3, session_id: demoSession.id, type: 'tool.start', timestamp: now, payload: { tool: 'read', summary: '读取 compute_sparsity.py' } },
  { version: 1, event_id: 4, session_id: demoSession.id, type: 'tool.end', timestamp: now, payload: { tool: 'update', summary: '将 window 从 4 更新为 8', diff: '- window=4\n+ window=8' } },
